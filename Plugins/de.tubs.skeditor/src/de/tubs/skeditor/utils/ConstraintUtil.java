...
public class ConstraintUtil {
	...
	private static Category[] mainParent = {}, mainChild = { Category.OBSERVABLE_EXTERNAL_BEHAVIOR };
	private static Category[] obsParent = { Category.MAIN }, obsChild = { Category.ACTION, Category.PLANNING };
	private static Category[] actionParent = { Category.OBSERVABLE_EXTERNAL_BEHAVIOR, Category.ACTION },
			actionChild = { Category.ACTION, Category.PERCEPTION, Category.PLANNING, Category.ACTUATOR };
	private static Category[] actuatorParent = { Category.ACTION }, actuatorChild = {};
	private static Category[] planningParent = { Category.OBSERVABLE_EXTERNAL_BEHAVIOR, Category.ACTION }, planningChild = { Category.PERCEPTION };
	private static Category[] perceptionParent = { Category.PLANNING, Category.ACTION, Category.PERCEPTION }, perceptionChild = { Category.SENSOR, Category.PERCEPTION };
	private static Category[] sensorParent = { Category.PERCEPTION }, sensorChild = {};
